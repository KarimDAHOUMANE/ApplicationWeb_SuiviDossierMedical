...
(function ($){
	...
	var djv_style="display:none; color:#8c2525; text-align:inherit; font:.9em fantasy bold italic;";
	var djv_labels={
			...
			atext_between:'Saisir $1 à $2 caractères. (Lettres uniquement)',
			...
			text_between:'Saisir $1 à $2 caractères.',
			...
			phone:'N° de téléphone non valide.',
			url:'Invalid url.',
